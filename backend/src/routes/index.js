...
router.get('/tasks/:id/time-entries', authenticate, tasksCtrl.listTimeEntries);
router.post('/tasks/:id/time-entries', authenticate, tasksCtrl.createTimeEntry);
router.patch('/tasks/:id/time-entries/:entryId', authenticate, tasksCtrl.updateTimeEntry);
router.delete('/tasks/:id/time-entries/:entryId', authenticate, tasksCtrl.deleteTimeEntry);
...
router.get('/users/:id/platform-roles', authenticate, requireAdmin, usersCtrl.getPlatformRoles);
router.put('/users/:id/platform-roles', authenticate, requireAdmin, usersCtrl.upsertPlatformRole);
router.delete('/users/:id/platform-roles/:platform', authenticate, requireAdmin, usersCtrl.removePlatformRole);
